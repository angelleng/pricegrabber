...
page.open("https://www.studentuniverse.com/flights/1/DTT/WUH/2015-06-30/WUH/DTT/2015-07-31", function (status) {
    ...
    if (status !== "success") {
        ...
        // console.log($('#global-actions').is(':visible')); 
        waitFor(
            // "$('#global-actions').is(':visible');"
            function() {
            // Check in the page if a specific element is now visible
            return page.evaluate(function() {
                return $(".flight-item-wrap").is(":visible");
            });
        },
        function() {
