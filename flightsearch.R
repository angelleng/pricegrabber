##### code for orbitz #########
a <- # example url, for display purpose 
...
######## for Google Flights ##########
a <- "https://www.google.com/flights/#search;f=DTW;t=WUH;d=2015-07-02;r=2015-08-09;so=p;eo=e"
...
urls <- paste0("https://www.google.com/flights/#search;f=DTW;t=WUH;d=", pairs$departure, ";r=", pairs$returndate, ";so=p;eo=e")
quotedurls <- paste0("\"", urls, "\"")

scripts <- paste("phantomjs", "grab_gf.js", quotedurls)
scripts <- c("#!/bin/bash", "set -x #echo on", scripts)
writeLines(scripts, "autogf.sh")
